...
--#endregion
    ...
    local win = DiscordLib:Window("Epu Hub Premium Script "..versionx.." - "..exec)
       
    if exec == "Synapse X" or exec == "ScriptWare" or exec == "Trigon" then
        print("Good boi")
    else
        local gettrigonserver = win:Server("Epu Hub", "http://www.roblox.com/asset/?id=7628278821")
        local gettrigon = gettrigonserver:Channel("Epu Hub No.1")
        gettrigon:Label("Script Dee M a k M a k")
        gettrigon:Label("🧮[UPD 8 Anime Adventures]🧮")
        gettrigon:Button("Discord Epu Hub", function()
            setclipboard("https://discord.gg/2JnSpMZsta")
            DiscordLib:Notification("Copied!!", "✔ Epu Hub's Discord Invite Link Has Been Copied To Your Clipboard!!", "Okay!")
        end)
    end
...
local worlddrop = autoclngtab:Dropdown("//Select Reward\\", {"⭐StarFruit⭐","⭐star_remnant⭐","💎gems💎", "🍌gold🍌"}, getgenv().selectedreward, function(reward)
    getgenv().selectedreward = reward
    updatejson()
end)
...
print("ScriptLoaded Sucessfully")
---------------------------------------------------------------------
